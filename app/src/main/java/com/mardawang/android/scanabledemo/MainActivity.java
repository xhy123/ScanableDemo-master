...
import com.mardawang.android.scanabledemo.util.PermissionsUtils;
import com.scanlibrary.ScanActivity;
import com.scanlibrary.ScanConstants;

import java.io.IOException;

public class MainActivity extends AppCompatActivity implements View.OnClickListener,PermissionsUtils.OnPermissionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 需要请求的权限
        String permissions[] = {Manifest.permission.CAMERA, Manifest.permission.WAKE_LOCK,Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE};
        // 获取权限
